...
import { banglaToEnglishNumber } from "@/utils/banglaToEnglishNumber/banglaToEnglishNumber";
...
const CartProducts = () => {
  ...
  useEffect(() => {
    const close = () => dispatch(addCartFlag(false));
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {item.quantity} × ${banglaToEnglishNumber(item.price)}
                      </p>
                      {/* Quantity controls */}
